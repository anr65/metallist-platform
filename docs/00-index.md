...
- [Подтверждение реестра без тарифа 21.09.2026](operations/registry-confirmation-missing-tariff-20260921.md)
...
- [Общий доступ сборщиков к картам](operations/global-card-access-migration.md)

...
- `cards(id, bank_id, last4, mask, owner_label, status, pan_ciphertext nullable)`; исходный полный PAN хранится отдельным зашифрованным файлом, исправленный — в шифртексте таблицы; ключ находится вне БД и Git

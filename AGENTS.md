...
- Paginate every data table at 15 rows by default. Use server pagination for large lists and keep active filters when changing pages. Directory sections use modal create and edit forms; the directory landing page contains navigation cards.
